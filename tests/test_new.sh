...
export LIB_0_LIB_TYPE="Open-MPI"
...
export LIB_0_ALLREDUCE_ALGORITHMS="default_ompi,linear_ompi"
...
export LIB_1_LIB_TYPE="Open-MPI"
...
export LIB_1_ALLREDUCE_ALGORITHMS="rabenseifner_ompi"
export LIB_1_ALLREDUCE_ALGORITHMS_SKIP="rabenseifner_ompi"
