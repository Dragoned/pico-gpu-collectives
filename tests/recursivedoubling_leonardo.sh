...
export LIB_0_ALLGATHER_ALGORITHMS="recursivedoubling_hierarchy_over"
export LIB_0_ALLGATHER_ALGORITHMS_SKIP="recursivedoubling_hierarchy_over"
export LIB_0_ALLGATHER_ALGORITHMS_IS_SEGMENTED="no"
