...
export LIB_0_ALLREDUCE_ALGORITHMS="recursive_doubling_ompi,ring_ompi,rabenseifner_ompi"
export LIB_0_ALLREDUCE_ALGORITHMS_SKIP="ring_ompi,rabenseifner_ompi"
...
export LIB_1_ALLREDUCE_ALGORITHMS="recursive_doubling_ompi,ring_ompi,rabenseifner_ompi"
export LIB_1_ALLREDUCE_ALGORITHMS_SKIP="ring_ompi,rabenseifner_ompi"
