...
int reduce_scatter_recursive_doubling_hierarchical_v3(REDUCE_SCATTER_MPI_ARGS);
int reduce_scatter_recursive_doubling_hierarchical_v4(REDUCE_SCATTER_MPI_ARGS);
