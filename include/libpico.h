...
int allgather_recursivedoubling_hierarchy_all_rank(ALLGATHER_MPI_ARGS);
int allgather_recursivedoubling_hierarchy_local_parallel(ALLGATHER_MPI_ARGS);
int allgather_bine_block_by_block_hierarchical_local_global(ALLGATHER_MPI_ARGS);
int allgather_bine_block_by_block_hierarchical_global_local(ALLGATHER_MPI_ARGS);
int allgather_bine_send_remap_hierarchical_local_global(ALLGATHER_MPI_ARGS);
int allgather_bine_send_remap_hierarchical_global_local(ALLGATHER_MPI_ARGS);
int allgather_bine_2_blocks_hierarchical(ALLGATHER_MPI_ARGS);
int allgather_bine_permutation_hierarchical_local_global(ALLGATHER_MPI_ARGS);
int allgather_bine_permutation_hierarchical_global_local(ALLGATHER_MPI_ARGS);
...
int reduce_scatter_recursive_doubling_hierarchical_global_local(REDUCE_SCATTER_MPI_ARGS);
int reduce_scatter_recursive_doubling_hierarchical_local_global(REDUCE_SCATTER_MPI_ARGS);
int reduce_scatter_recursive_doubling_hierarchical_local_parallel(REDUCE_SCATTER_MPI_ARGS);
int reduce_scatter_recursive_doubling_hierarchical_segmented(REDUCE_SCATTER_MPI_ARGS);
...
int reduce_scatter_bine_permute_remap_hierarchical(REDUCE_SCATTER_MPI_ARGS);
int reduce_scatter_bine_permute_remap_hierarchical_rotating_buff(REDUCE_SCATTER_MPI_ARGS);
